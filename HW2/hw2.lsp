...
; iterative-deepening. Your top-level function, called DFID, should
; take two arguments, the list representation of the tree, and an
; integer representing the maximum depth of the tree, and return a
; single top-level list of the terminal nodes in the order that they
